...
function App() {
  ...
  const movieListKey = `${moviePage}-${debouncedQuery}-${selectedGenre ?? 'all'}`;
                    ...
                    (movieData?.results?.length ?? 0) > 0 && (
                      <div className="pagination-container">
                        <button
                          ...
                          onClick={() => {
                            setMoviePage((prev) => Math.max(prev - 1, 1));
                            scrollToTop();
                          }}
                        >
                          &larr; Poprzednia
                        ...
                        <span className="pagination-text">
                          {isMoviesFetching
                            ? 'Wczytywanie...'
                            : `Strona ${moviePage} z ${movieData!.total_pages}`}
                        </span>
                        <button
                          className="pagination-button"
                          disabled={
                            moviePage >= movieData!.total_pages || isMoviesFetching
                          }
                          onClick={() => {
                ...
                <>
                  ...
                  <div className="pagination-container">
                    <button
                      ...
                      onClick={() => {
                        setRmPage((prev) => Math.max(prev - 1, 1));
                        scrollToTop();
                      }}
                    >
                      &larr; Poprzednia
                    ...
                    <span className="pagination-text">
                      {isRMFetching
                        ? 'Wczytywanie...'
                        : `Strona ${rmPage} z ${rmData.info.pages}`}
                    </span>
                    <button
                      className="pagination-button"
                      disabled={rmPage >= rmData.info.pages || isRMFetching}
                      onClick={() => {
                        setRmPage((prev) => prev + 1);
                        scrollToTop();
                      }}
                    >
                      Następna &rarr;
